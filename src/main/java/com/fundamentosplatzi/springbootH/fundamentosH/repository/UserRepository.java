...
public interface UserRepository extends PagingAndSortingRepository<User, Long> { //metodos relacionados con la paginación (numero de pagina y tamaño de la pagina)
